const data = [
  {
    ...
    stars: 4,
    location: "Coruscant",
    reviews: [{ userId: 1, name: "John Doe", starsGiven: 4.5 }],
  },
  {
    id: 2,
    title: "Wookiee Bites",
    ...
    stars: 4.2,
    location: "Kashyyyk",
    reviews: [{ userId: 2, name: "Leia Skywalker", starsGiven: 4.0 }],
  },
  {
    id: 3,
    title: "Ewok Eats",
    ...
    stars: 4.7,
    location: "Endor",
    reviews: [{ userId: 3, name: "Han Solo", starsGiven: 5.0 }],
  },
  {
    id: 4,
    ...
    stars: 4.5,
    location: "Tatooine",
    reviews: [{ userId: 4, name: "Padmé Amidala", starsGiven: 4.8 }],
  },
  {
    id: 5,
    ...
    stars: 3.8,
    location: "Mos Eisley",
    reviews: [{ userId: 5, name: "Lando Calrissian", starsGiven: 4.2 }],
  },
  {
    id: 6,
    ...
    stars: 4.3,
    location: "Coruscant",
    reviews: [{ userId: 6, name: "C-3PO", starsGiven: 4.5 }],
  },
  {
    id: 7,
    title: "Sith Sizzles",
    ...
    stars: 3.9,
    location: "Mustafar",
    reviews: [{ userId: 7, name: "Darth Vader", starsGiven: 4.0 }],
  },
  {
    id: 8,
    title: "Hutt Hunch",
    ...
    stars: 4.1,
    location: "Nal Hutta",
    reviews: [{ userId: 8, name: "Jabba the Hutt", starsGiven: 4.3 }],
  },
  {
    id: 9,
    ...
    stars: 4.6,
    location: "Coruscant",
    reviews: [{ userId: 9, name: "Qui-Gon Jinn", starsGiven: 4.7 }],
  },
  {
    id: 10,
    ...
    stars: 4.4,
    location: "Naboo",
    reviews: [{ userId: 10, name: "Ahsoka Tano", starsGiven: 4.6 }],
  },
];
